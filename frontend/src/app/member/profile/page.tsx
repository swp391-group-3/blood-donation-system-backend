        ...
        <Tabs defaultValue="profile" className="space-y-6">
              ...
              <CardContent className="space-y-6">
                <div className="grid gap-6 md:grid-cols-2">
                  <div className="space-y-2">
                    ...
                    <Input id="fullName" placeholder="Enter your full name" defaultValue="John Smith" readOnly />
                  </div>
                  <div className="space-y-2">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <Input id="dateOfBirth" type="date" className="pr-10" readOnly />
          ...
          <TabsContent value="privacy" className="space-y-6">
            <Card>
              ...
              <CardContent>
                <p className="text-muted-foreground">Privacy settings will be available here.</p>
              </CardContent>
            </Card>
          </TabsContent>
