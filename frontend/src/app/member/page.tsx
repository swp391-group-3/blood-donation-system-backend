          ...
          <CardContent className="space-y-6">
            <div className="grid grid-cols-1">
              <div className="text-center">
                ...
                <div className="text-sm text-zinc-500">Donations</div>
              </div>
            </div>
            ...
            <div className="space-y-1">
              ...
              <div className="flex justify-between text-sm">
                ...
                <span className="text-zinc-500">2 donations to go</span>
              </div>
            </div>
      ...
      <Card>
        <CardHeader>
          ...
          <p className="text-sm text-zinc-600">
            Active blood requests that match your blood type or need urgent
            attention
          </p>
        </CardHeader>
