...
import { Droplet, Plus, Search, Filter, Calendar, MapPin, Users, Clock, AlertTriangle, Heart } from "lucide-react"
...
export default function BloodRequestPage() {
    ...
    return compatible[userBloodGroup].includes(requestBloodGroup as BloodType);
    }

    const getRecommendedRequests = () => {
        return mockRequests.filter((request) => isCompatibleBloodGroup(request.bloodGroup) || request.priority === "high")
    }
    ...
    return (
        <div className="flex-1 space-y-6 p-6">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    <h1 className="text-3xl font-bold tracking-tight">Blood Donation Requests</h1>
                    <p className="text-gray-500">Find and respond to blood donation opportunities</p>
                </div>
            </div>
            ...
            {filteredRequests.length > 0 ? (
              <div className="grid gap-6">
                {filteredRequests.map((request) => {
                  ...
                  const isCompatible = isCompatibleBloodGroup(request.bloodGroup)
                  ...
                  return (
                    <Card
                      ...
                      className={`transition-all duration-200 hover:shadow-lg ${
                        isCompatible ? "ring-2 ring-green-200 bg-green-50/30" : ""
                      }`}
                    >
                          ...
                          <div className="space-y-4 flex-1">
                            <div className="flex items-start gap-3">
                              ...
                              <div className="flex-1">
                                <div className="flex items-center gap-2 mb-2">
                                  ...
                                  {isCompatible && <Badge className="bg-green-500">Compatible</Badge>}
                                </div>
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                              <div className="flex items-center gap-2">
                                ...
                                <div>
                                  <p className="text-sm font-medium">{request.bloodGroup}</p>
                              ...
                              <div className="flex items-center gap-2">
                                ...
                                <div>
                                  <p className="text-sm font-medium">{request.estimatedTimeLeft}</p>
                            ...
                            <div className="space-y-2">
                              <div className="flex items-center justify-between">
                                ...
                                <span className="text-sm text-gray-500">{Math.round(progressPercentage)}% filled</span>
                              </div>
          ...
          <TabsContent value="recommended" className="space-y-6">
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
              ...
              <p className="text-sm text-blue-700">
                These requests are recommended based on your blood type ({userBloodGroup}) and urgent needs in your
                area.
              </p>
            </div>
                    ...
                    >
                      <CardContent className="p-6">
                        <div className="flex items-center gap-2 mb-3">
                          ...
                          {isCompatible && <Badge className="bg-green-500">Perfect Match</Badge>}
                        </div>
                        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                          <div className="space-y-4 flex-1">
                            <div className="flex items-start gap-3">
                          ...
                          <div className="flex flex-col gap-3 lg:w-48">
                            <Button className="w-full bg-blue-600 hover:bg-blue-700" asChild>
                              <Link href={`/dashboard/requests/${request.id}/apply`}>Apply to Donate</Link>
                            </Button>
                            <Button variant="outline" className="w-full" asChild>
                              <Link href={`/dashboard/requests/${request.id}`}>View Details</Link>
                            </Button>
          ...
          <TabsContent value="urgent" className="space-y-6">
            <div className="bg-red-50 border border-red-200 rounded-lg p-4 mb-6">
              <div className="flex items-center gap-2 mb-2">
                ...
                <h3 className="font-medium text-red-800">Urgent Blood Requests</h3>
              </div>
              <p className="text-sm text-red-700">
                These requests require immediate attention and have high priority status.
              </p>
            </div>

            {mockRequests.filter((r) => r.priority === "high").length > 0 ? (
              <div className="grid gap-6">
                {mockRequests
                          ...
                          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                            <div className="space-y-4 flex-1">
                              ...
                              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                ...
                                <div className="flex items-center gap-2">
                                  ...
                                  <div>
                                    <p className="text-sm font-medium text-orange-600">{request.estimatedTimeLeft}</p>
                                    <p className="text-xs text-gray-500">Critical Timeline</p>
                                  </div>
                                </div>
                                <div className="flex items-center gap-2">
                                  <MapPin className="h-4 w-4 text-green-500" />
                                ...
                                <div className="flex items-center gap-2">
                                  ...
                                  <div>
                                    <p className="text-sm font-medium text-red-600">
                                      {request.maxPeople - request.currentPeople} still needed
                                    </p>
                              ...
                              <div className="space-y-2">
                                <div className="flex items-center justify-between">
                                  <span className="text-sm font-medium">Emergency Progress</span>
                            ...
                            <div className="flex flex-col gap-3 lg:w-48">
                              <Button className="w-full bg-red-600 hover:bg-red-700 animate-pulse" asChild>
                                <Link href={`/dashboard/requests/${request.id}/apply`}>RESPOND NOW</Link>
                              </Button>
                              <Button variant="outline" className="w-full border-red-200" asChild>
                                <Link href={`/dashboard/requests/${request.id}`}>Emergency Details</Link>
                              </Button>
                            </div>
                          </div>
                        </CardContent>
              ...
              />
                ...
                <Card>
                    <CardContent className="p-6 text-center">
                    <div className="text-3xl font-bold text-blue-600 mb-2">{getRecommendedRequests().length}</div>
                ...
                <Card>
                    ...
                    <p className="text-sm text-gray-600">Donors Still Needed</p>
                    </CardContent>
                </Card>
                </div>
        </div>
