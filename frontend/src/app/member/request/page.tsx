            ...
            <div className="grid gap-6">
              {filteredRequests.map((request) => {
                ...
                const progressPercentage =
                  (request.currentPeople / request.maxPeople) * 100;
        ...
        <TabsContent value="recommended" className="space-y-6">
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
            ...
            <p className="text-sm text-blue-700">
              These requests are recommended based on your blood type (
              {userBloodGroup}) and urgent needs in your area.
            </p>
          </div>
        ...
        <TabsContent value="urgent" className="space-y-6">
          <div className="bg-red-50 border border-red-200 rounded-lg p-4 mb-6">
            ...
            <p className="text-sm text-red-700">
              These requests require immediate attention and have high priority
              status.
            </p>
          </div>
                              ...
                              <div className="flex items-center gap-2">
                                ...
                                <div>
                                  <p className="text-sm font-medium text-red-600">
                                    {request.maxPeople - request.currentPeople}{" "}
                                    still needed
                                  </p>
                                  <p className="text-xs text-gray-500">
                                    Urgent Need
        ...
        <Card>
          <CardContent className="p-6 text-center">
            <div className="text-3xl font-bold text-green-600 mb-2">
              {mockRequests.reduce(
                (sum, r) => sum + (r.maxPeople - r.currentPeople),
                0,
              )}
            </div>
