...
import { FileText, Plus, Search, Calendar, Heart, MessageCircle, Eye, Filter } from "lucide-react"
...
export default function BlogPage() {
  ...
  const blogPosts: BlogPost[] = [
    ...
    },
    {
      ...
      excerpt: "A personal story about overcoming fears and making a difference through blood donation.",
      content: "Full content here...",
      author: {
        name: "Michael Chen",
        role: "member",
    ...
    },
    {
      ...
      excerpt: "Understanding different blood types, compatibility, and why certain types are more in demand.",
      content: "Full content here...",
      author: {
    ...
    },
    {
      ...
      excerpt: "How our recent community blood drive exceeded expectations and made a real impact.",
      content: "Full content here...",
      author: {
        name: "Jennifer Adams",
        role: "staff",
    ...
    },
    {
      ...
      excerpt: "Essential tips and guidelines to ensure you're ready for a successful blood donation.",
      content: "Full content here...",
      author: {
        name: "Robert Kim",
        role: "member",
    ...
    },
    {
      ...
      excerpt: "Exploring how blood is processed, stored, and maintained to ensure safety and effectiveness.",
      content: "Full content here...",
      author: {
      ...
      <div className="space-y-6 p-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <p className="text-gray-500">Share stories, tips, and knowledge about blood donation</p>
          </div>
          <Button asChild>
          ...
          <div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {featuredPosts.slice(0, 2).map((post) => (
                <Card key={post.id} className="border-2 border-blue-200 bg-blue-50">
                  <CardHeader>
                    ...
                    <CardTitle className="line-clamp-2">
                      <Link href={`/dashboard/blog/${post.id}`} className="hover:text-blue-600">
                        {post.title}
                      </Link>
                    </CardTitle>
                      ...
                      <div className="flex items-start justify-between gap-4">
                        <div className="flex-1">
                          <div className="flex items-center gap-2 mb-2">
                            <Badge variant="outline">{post.category}</Badge>
                            {post.featured && <Badge className="bg-blue-600 text-white">Featured</Badge>}
                            <Badge
                              variant="outline"
                              className={
