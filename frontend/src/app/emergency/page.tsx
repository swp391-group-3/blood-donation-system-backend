        ...
        <div className="space-y-6 p-6">
            ...
            <div className="bg-gradient-to-r from-red-600 to-red-700 text-white p-6 rounded-lg">
                <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                        ...
                        <p className="text-red-100">
                            Critical situations requiring immediate donor
                            response
                        </p>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div className="bg-white bg-opacity-10 p-4 rounded-lg">
                        <div className="text-2xl font-bold">
                            {emergencyRequests.reduce(
                                (sum, r) =>
                                    sum + (r.unitsNeeded - r.unitsSecured),
                                0,
                            )}
                        </div>
                            ...
                            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                                ...
                                <div className="flex flex-col gap-3 lg:w-48">
                                    <Button
                                        ...
                                        onClick={() =>
                                            handleEmergencyResponse(request.id)
                                        }
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-blue-700">
                        <div>
                            ...
                            <ul className="space-y-1">
                                <li>
                                    • Ensure you're eligible to donate (8+ weeks
                                    since last donation)
                                </li>
                                <li>• Eat a healthy meal and stay hydrated</li>
                                <li>
                                    • Bring valid ID and emergency contact info
                                </li>
                                <li>
                                    • Inform the hospital you're responding to
                                    an emergency
                                </li>
                            </ul>
                        </div>
                        <div>
                            ...
                            <ul className="space-y-1">
                                ...
                                <li>
                                    • Emergency donations are processed
                                    immediately
                                </li>
                            </ul>
                        </div>
